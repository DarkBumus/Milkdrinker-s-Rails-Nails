...
public class BlockRailCopper extends BlockRail implements ISuspendedRail {

    private final int suspendedLength;

    public BlockRailCopper(String name, CreativeTabs tab, int suspendedLength) {
        super();
        this.suspendedLength = suspendedLength;
        setBlockName(name);
        setCreativeTab(tab);
        propertiesCopperRail(this);
    }
