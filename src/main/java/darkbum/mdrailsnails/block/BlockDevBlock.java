...
public class BlockDevBlock extends Block {
    ...
    public void registerBlockIcons(IIconRegister icon) {
        iconSide0Bottom = icon.registerIcon("mdrailsnails:dev/dev_side0bottom");
        iconSide1Top = icon.registerIcon("mdrailsnails:dev/dev_side1top");
        iconSide2North = icon.registerIcon("mdrailsnails:dev/dev_side2north");
        iconSide3South = icon.registerIcon("mdrailsnails:dev/dev_side3south");
        iconSide4West = icon.registerIcon("mdrailsnails:dev/dev_side4west");
        iconSide5East = icon.registerIcon("mdrailsnails:dev/dev_side5east");
    }
