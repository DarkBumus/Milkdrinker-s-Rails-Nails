...
import static darkbum.mdrailsnails.util.ItemUtils.addItemTooltip;

public class ItemBlockConductor extends ItemBlock {

    public ItemBlockConductor(Block block) {
        super(block);
    }
