...
public class BlockRailMounting extends BlockRailPowered {

    public BlockRailMounting(String name, CreativeTabs tab) {
        super();
        setBlockName(name);
        setCreativeTab(tab);
    ...
    public void onMinecartPass(World world, EntityMinecart cart, int x, int y, int z) {
        handleMountingCartBehavior(world, cart, x, y, z);
    }
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z, EntityPlayer player) {
        return new ItemStack(mounting_rail);
    }

    @Override
    public Item getItemDropped(int meta, Random random, int fortune) {
        return getItemFromBlock(mounting_rail);
    }
}
