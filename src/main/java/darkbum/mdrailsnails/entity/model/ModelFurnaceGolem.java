...
public class ModelFurnaceGolem extends ModelBase {
    ...
    public ModelFurnaceGolem(float modelSize) {
        this(modelSize, -7.0F);
    }

    public ModelFurnaceGolem(float modelSize, float yOffset) {
        ...
        ironGolemHead.setTextureOffset(0, 18).addBox(-4.0f, -12.0f, -7.5f, 8, 5, 2, modelSize);
