...
public class ModelMuddyPig extends ModelQuadruped {

    public ModelMuddyPig() {
        this(0.0F);
    }

    public ModelMuddyPig(float scale) {
        super(6, scale);
        textureWidth = 64;
        textureHeight = 64;
        ...
        // Mud Spot - NEW
        head.setTextureOffset(24, 0).addBox(-1.0f, -5.0f, -7.0f, 4, 1, 4, 0.0f);

        // Flower - NEW
        head.setTextureOffset(40, 0).addBox(0.0f, -11.0f, -5.0f, 4, 6, 0, 0.0f);
