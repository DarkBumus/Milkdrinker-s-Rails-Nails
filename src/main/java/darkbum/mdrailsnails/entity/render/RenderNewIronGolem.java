...
import darkbum.mdrailsnails.entity.model.ModelNewIronGolem;
...
public class RenderNewIronGolem extends RenderLiving {
    private static final ResourceLocation ironGolemTextures = new ResourceLocation("mdrailsnails:textures/entity/iron_golem/iron_golem.png");
    private static final ResourceLocation lowCrackTextures = new ResourceLocation("mdrailsnails:textures/entity/iron_golem/iron_golem_crackiness_low.png");
    private static final ResourceLocation mediumCrackTextures = new ResourceLocation("mdrailsnails:textures/entity/iron_golem/iron_golem_crackiness_medium.png");
    private static final ResourceLocation highCrackTextures = new ResourceLocation("mdrailsnails:textures/entity/iron_golem/iron_golem_crackiness_high.png");

    /** Iron Golem's Model. */
    private final ModelNewIronGolem ironGolemModel;

    public RenderNewIronGolem(ModelBase modelBase1, ModelBase modelBase2, float shadowSize) {
        super(modelBase1, shadowSize);
        setRenderPassModel(modelBase2);
        ironGolemModel = (ModelNewIronGolem)mainModel;
    }
