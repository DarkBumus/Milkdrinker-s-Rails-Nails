...
public class RenderNewChicken extends RenderLiving {

    private static final ResourceLocation chickenTextures = new ResourceLocation("mdrailsnails:textures/entity/chicken/temperate_chicken.png");

    public RenderNewChicken(ModelBase modelBase, float shadowSize) {
