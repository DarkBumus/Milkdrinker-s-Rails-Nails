...
public class RenderMuddyPig extends RenderLiving {
    ...
    private static final ResourceLocation pigTextures = new ResourceLocation("mdrailsnails:textures/entity/pig/muddy_pig.png");

    public RenderMuddyPig(ModelBase modelBase1, ModelBase modelBase2, float shadowSize) {
