...
public class RenderWarmChicken extends RenderLiving {

    private static final ResourceLocation chickenTextures = new ResourceLocation("mdrailsnails:textures/entity/chicken/warm_chicken.png");

    public RenderWarmChicken(ModelBase modelBase, float shadowSize) {
