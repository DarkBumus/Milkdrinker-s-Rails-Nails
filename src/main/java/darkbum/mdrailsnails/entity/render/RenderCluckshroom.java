...
public class RenderCluckshroom extends RenderLiving {

    private static final ResourceLocation chickenTextures = new ResourceLocation("mdrailsnails:textures/entity/chicken/cluckshroom.png");

    public RenderCluckshroom(ModelBase modelBase, float shadowSize) {
