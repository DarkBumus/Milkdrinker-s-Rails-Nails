...
public class RenderFancyChicken extends RenderLiving {

    private static final ResourceLocation chickenTextures = new ResourceLocation("mdrailsnails:textures/entity/chicken/fancy_chicken.png");

    public RenderFancyChicken(ModelBase modelBase, float shadowSize) {
