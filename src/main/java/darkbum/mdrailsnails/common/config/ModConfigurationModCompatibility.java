...
public class ModConfigurationModCompatibility {
    ...
    public static void init(Configuration config) {
        ...
        enableEFRHoneyCompatibility = config.getBoolean(
            ...
            categoryNameModIte,
            true,
            "Integrates MDRailsNails Expanded's Honey into Et Futurum Requiem's Honey as best as possible."
                ...
                + "\nHoney Bottles will become craftable with MDRailsNails's Honeycombs and Honeycomb Blocks will become craftable with MDRailsNails's Waxcombs."
